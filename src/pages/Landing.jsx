            ...
            <Col md={6} className="text-white">
              ...
              <div className="cv-links">
                <Button
                  variant="light"
                  className="button"
                  href="https://drive.google.com/file/d/1fC8_QWxdG3oxsmW1ptTTNksNzfwNxpPW/view?usp=drive_link"
                  target="_blank"
                  download
                >
                  CV en español
                ...
                <Button
                  variant="light"
                  className="button"
                  href="https://drive.google.com/file/d/1YGFIPXYhD2kf4RZy1GZwjFFUswwPICoj/view?usp=drive_link"
                  target="_blank"
                  download
                >
                  CV en inglés
